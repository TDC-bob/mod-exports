...
if disposition == 'L' then
	try_find_assigned_viewport("ED_A10C_LEFT_MFCD")
else 
	try_find_assigned_viewport("ED_A10C_RIGHT_MFCD")
end
...
id_pagesubset =
{
	...
	MFCD_TGP_RENDER_MAIN		= 65,
	MFCD_TGP_RENDER_STBYINIT	= 66,
	MFCD_TGP_RENDER_STBYBIT		= 67,
	MFCD_TGP_STBY_CONTROL_PAGE	= 68,
	MFCD_TGP_STBY_PAGE_OPER		= 69,
