...
-- modules = {"CockpitKa50"} --moved to mods Ka-50 folder

mount_vfs_model_path(LockOn_Options.script_path.."../Resources/Model/Shape")
mount_vfs_texture_archives(LockOn_Options.script_path.."../Resources/Model/Textures/Cockpit-Ka-50 Textures")
...
function maintenance_setup_HMS()
    local  ret_val ={}
           ret_val[1] = {[devices.HELMET] = {
                               "Ka50::avHelmet_3UM",
								LockOn_Options.script_path.."Devices_specs/HELMET.lua",
...
creators[devices.SNS]   = 	{	"avSNS_GPS_GNSS_Listener",
								LockOn_Options.script_path.."Devices_specs/SNS.lua"
							}
...
creators[devices.UV_26]	= {"Ka50::avUV_26",
...
if LockOn_Options.flight.easy_radar then                                            
	creators[devices.ARCADE] =          {"Ka50::avArcadeRadar_Ka50",
...
indicators[#indicators + 1] = {"ccEkranIndicator"     		, LockOn_Options.script_path.."EKRAN/Indicator/EKRAN_init.lua"         ,devices.EKRAN_32_03     ,{{"EKRAN-CENTER", "EKRAN-DOWN", "EKRAN-RIGHT"},{sz_l = -0.0005,sy_l = 0.0013}}}
...
indicators[#indicators + 1] = {"Ka50::ccUV_26"              , LockOn_Options.script_path.."UV_26/UV_26_init.lua"                   ,devices.UV_26           ,{{"UV-26-CENTER", "UV-26-DOWN", "UV-26-RIGHT"}}}
...
if LockOn_Options.flight.easy_radar then                                            
	indicators[#indicators + 1] = {"Ka50::ccArcadeRadar_Ka50"   ,LockOn_Options.script_path.."ARCADE/arcade_indicator.lua"             ,devices.ARCADE}
end
